...
4. **Using a simple HTTP server is an excellent teaching tool**
- `py -m http.server 8080` plus `curl` and Wireshark gives a clean, easy-to-read example of the TCP handshake, HTTP request/response, and connection close.
